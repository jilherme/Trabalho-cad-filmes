            ...
            <div class="form-group">
                ...
                <div class="form-control col-sm-6" >
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"  name="genero[]" type="checkbox" value="Ação" <?php echo (in_array("Ação", $genero) ? "checked" : null); ?> disabled>
                        <label class="form-check-label">Ação</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"  name="genero[]" type="checkbox" value="Animação" <?php echo (in_array("Animação", $genero) ? "checked" : null); ?> disabled>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"  name="genero[]" type="checkbox" value="Comédia" <?php echo (in_array("Comédia", $genero) ? "checked" : null); ?> disabled>
                        <label class="form-check-label">Comédia</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"  name="genero[]" type="checkbox" value="Documentário" <?php echo (in_array("Documentário", $genero) ? "checked" : null); ?> disabled>
